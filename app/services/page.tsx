                   ...
                   {services.map((service, index)=> {
                       return <div key={index} className="flex flex-1 flex-col justify-center gap-6 group cardBlock">
                           <div className="flex w-full justify-between items-center">
                               ...
                               <Link href={service.href} className="arrow w-[70px] h-[70px] rounded-full bg-white group-hover:bg-accent transition-all duration-500 flex justify-center items-center hover:-rotate-45">
