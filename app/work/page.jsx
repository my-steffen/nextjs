                ...
                <div className="flex flex-col xl:flex-row xl-gap-[30px]">
                    <div
                        ...
                        <div className="flex flex-col gap-[30px] h-[50%]">
                            ...
                            {/*Project Category*/}
                            <h2 className="text-[42px] font-bold leading-none text-[#414140] group-hover:text-accent transition-all duration-500 capitalize">{project.category} project</h2>
                            {/*Project Description*/}
                            <p className="text-[#414140]/60">{project.description}</p>
                            {/*{stock}*/}
                            <ul className="flex gap-4">
                                {project.stack.map((item, index)=> {
                                    return <li className="text-[18px] text-accent" key={index}>
                                        {item.name}
                    ...
                    <div className="w-full xl:w-[50%]">
                        <Swiper spaceBetween={30} slidesPerView={1} className="xl:h-[520px] mb-12" onSlideChange={handleSlideChange}>
                            ...
                            {/*slider button*/}
                            <WorkSliderBtns containerStyle="flex gap-2 absolute right-0 bottom-[calc(50%_-_22px)] xl:bottom-0 z-20
